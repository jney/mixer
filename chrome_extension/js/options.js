...
/***/ function(module, exports, __webpack_require__) {
	...
	var Vinyl = __webpack_require__(3);

	React.render(
	    React.createElement(Vinyl, {image: chrome.extension.getURL('images/icon48.png')}),
	    document.body
	)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Vinyl = React.createClass({displayName: "Vinyl",
	  render: function(){
	    return (
	      React.createElement("div", {className: "vinyl vinyl-1 paused"}, 
	        React.createElement("div", {className: "grooves"}), 
	        React.createElement("div", {className: "light"}), 
	        React.createElement("div", {className: "light-alt"}), 
	        React.createElement("div", {className: "macaron"}, 
	          React.createElement("img", {className: "cover", src: this.props.image})
	        )
	      )
	    );
	  }
