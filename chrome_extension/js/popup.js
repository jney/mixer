...
/***/ function(module, exports, __webpack_require__) {
	...
	React.render(
	    React.createElement(Popup, {link: chrome.extension.getURL('views/options.html'), label: 'click here'}),
	    $('body').get(0)
	)
	    ...
	    render: function(){
	        return (
	            React.createElement("div", null, 
	                React.createElement("a", {href: this.props.link, target: "_blank"}, this.props.label)
	            )
	        );
	    }
	});
